...
- Create Angular project with ng: `ng new careerconnect.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`careerconnect.client.esproj`).
